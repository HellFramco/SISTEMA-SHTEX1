                                        ...
                                        ?>
                                            ...
                                            ?>
                                                ...
                                                <tr class="fila_sombra">
                                                    ...
                                                    <td><input style="color: black;" type="hidden" readonly value="<?php echo $key['referencia']; ?>" name="ee" id="referencia<?php echo $key['referencia']; ?>" class="form-control"><?php echo $key['referencia']; ?></td>
                                                    ...
                                                    <td><input type="number" placeholder="<?php echo $key['talla30']; ?>" min="0" max="<?php echo $key['talla30']; ?>" value="<?php echo $key['talla30']; ?>" name="talla30" id="talla30<?php echo $key['id_inventario']; ?>" class="form-control"></td>
                                                    <td><input type="number" placeholder="<?php echo $key['talla32']; ?>" min="0" max="<?php echo $key['talla32']; ?>" value="<?php echo $key['talla32']; ?>" name="talla32" id="talla32<?php echo $key['id_inventario']; ?>" class="form-control"></td>
                                                    <td><input type="number" placeholder="<?php echo $key['talla34']; ?>" min="0" max="<?php echo $key['talla34']; ?>" value="<?php echo $key['talla34']; ?>" name="talla34" id="talla34<?php echo $key['id_inventario']; ?>" class="form-control"></td>
                                                    <td><input type="number" placeholder="<?php echo $key['talla36']; ?>" min="0" max="<?php echo $key['talla36']; ?>" value="<?php echo $key['talla36']; ?>" name="talla36" id="talla36<?php echo $key['id_inventario']; ?>" class="form-control"></td>
                                                    <td><input type="number" placeholder="<?php echo $key['talla38']; ?>" min="0" max="<?php echo $key['talla38']; ?>" value="<?php echo $key['talla38']; ?>" name="talla38" id="talla38<?php echo $key['id_inventario']; ?>" class="form-control"></td>
                                                    <td><input type="number" placeholder="<?php echo $key['tallas']; ?>" min="0" max="<?php echo $key['tallas']; ?>" value="<?php echo $key['tallas']; ?>" name="tallas" id="tallas<?php echo $key['id_inventario']; ?>" class="form-control"></td>
                                                    <td><input type="number" placeholder="<?php echo $key['tallam']; ?>" min="0" max="<?php echo $key['tallam']; ?>" value="<?php echo $key['tallam']; ?>" name="tallam" id="tallam<?php echo $key['id_inventario']; ?>" class="form-control"></td>
                                                    <td><input type="number" placeholder="<?php echo $key['tallal']; ?>" min="0" max="<?php echo $key['tallal']; ?>" value="<?php echo $key['tallal']; ?>" name="tallal" id="tallal<?php echo $key['id_inventario']; ?>" class="form-control"></td>
                                                    <td><input type="number" placeholder="<?php echo $key['tallaxl']; ?>" min="0" max="<?php echo $key['tallaxl']; ?>" value="<?php echo $key['tallaxl']; ?>" name="tallaxl" id="tallaxl<?php echo $key['id_inventario']; ?>" class="form-control"></td>
                                                    <td><input type="number" placeholder="<?php echo $key['tallau']; ?>" min="0" max="<?php echo $key['tallau']; ?>" value="<?php echo $key['tallau']; ?>" name="tallau" id="tallau<?php echo $key['id_inventario']; ?>" class="form-control"></td>
                                                    <td><input type="number" placeholder="<?php echo $key['tallaest']; ?>" min="0" max="<?php echo $key['tallaest']; ?>" value="<?php echo $key['tallaest']; ?>" name="tallaest" id="tallaest<?php echo $key['id_inventario']; ?>" class="form-control"></td>

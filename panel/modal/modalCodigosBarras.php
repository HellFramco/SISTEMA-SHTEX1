...
<form action="../../modelo/accionesProductos.php" method="post">
	...
	<br>
		...
		?>
		<div class="col-sm-2">
			<label style="color: gray; text-transform: uppercase;" for="">de la talla 6 existen: <?php echo $key['talla6'] ?>
		...
		<div class="col-sm-2">
			<label style="color: gray; text-transform: uppercase;" for="">de la talla 8 existen: <?php echo $key['talla8'] ?>
		...
		<div class="col-sm-2">
			<label style="color: gray; text-transform: uppercase;" for="">de la talla 10 existen: <?php echo $key['talla10'] ?>
		...
		<div class="col-sm-2">
			<label style="color: gray; text-transform: uppercase;" for="">de la talla 12 existen: <?php echo $key['talla12'] ?>
		...
		<div class="col-sm-2">
			<label style="color: gray; text-transform: uppercase;" for="">de la talla 14 existen: <?php echo $key['talla14'] ?>
		...
		<div class="col-sm-2">
			<label style="color: gray; text-transform: uppercase;" for="">de la talla 16 existen: <?php echo $key['talla16'] ?>

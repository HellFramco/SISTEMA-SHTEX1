...
class productos
{
    ...
    function color_hexa($color)
    {
        ...
        if ($modules) {
            foreach ($modules as $key) {
                  $i = 1;
                echo "<em style='background-color:".$key['hexa']."; padding:5px; border-radius:20%; font-size:12px; text-aling-center;'>".$key['nameCol']."</em>";
            }
        }
    ...
    // Esto son las opciones de siluetas que existen desde la base de datos

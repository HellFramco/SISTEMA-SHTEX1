...
elseif ($accion == "modificar") {
  ...
  if ($reg->execute()) {
    ...
    // This will output the barcode as HTML output to display in the browser
            ...
            echo $codigoBarras;
            // echo '<div id="imagen_'.$codigoBarras.'"></div>';
            // echo "
            // <script>
            //     $('#imagen_".$codigoBarras."').html('<img style=´width: 200px;´ src=´../librerias/php-barcode/barcode.php?text="+$codigoBarras+"&size=90&codetype=Code39&print=true´/>');
            // </script>
            // ";
